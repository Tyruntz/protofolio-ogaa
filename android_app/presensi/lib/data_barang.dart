              ...
              return ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                          ...
                          showModalBottomSheet(
                            ...
                            builder: (context) {
                              return Container(
                                ...
                                child: Column(
                                  children: [
                                    Text('Edit Data Barang', style: TextStyle(fontSize: 30)),
                                    Padding(
                                    ...
                                    ElevatedButton(
                                      onPressed: () async {
                                       try {
                                         if (namaBarang.text.isNotEmpty && hargaModal.text.isNotEmpty && hargaJual.text.isNotEmpty && jumlahBarang.text.isNotEmpty) {
                                           await FirebaseFirestore.instance.collection('barang').doc(document.id).update({
                      ...
                      IconButton(
                        onPressed: () {
                          // FirebaseFirestore.instance.collection('barang').doc(document.id).delete();
                        },
